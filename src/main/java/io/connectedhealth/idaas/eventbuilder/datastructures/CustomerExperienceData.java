package io.connectedhealth.idaas.eventbuilder.datastructures;
...
public class CustomerExperienceData {
    ...
    public io.connectedhealth.idaas.hcdataobjects.common.Location getLocation() {
        return Location;
    }

    public void setLocation(io.connectedhealth.idaas.hcdataobjects.common.Location location) {
        Location = location;
    }

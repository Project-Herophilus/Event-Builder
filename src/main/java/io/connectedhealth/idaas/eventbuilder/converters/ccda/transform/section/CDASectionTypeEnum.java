...
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAAllergiesSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAEncountersSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAEncountersSectionEntriesOptional;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAFamilyHistorySection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAFunctionalStatusSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAImmunizationsSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAImmunizationsSectionEntriesOptional;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAMedicalEquipmentSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAMedicationsSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAProblemsSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAProceduresSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAResultsSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDASocialHistorySection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAUnplementedSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAVitalSignsSection;
import io.connectedhealth.idaas.eventbuilder.converters.ccda.transform.section.impl.CDAVitalSignsSectionEntriesOptional;

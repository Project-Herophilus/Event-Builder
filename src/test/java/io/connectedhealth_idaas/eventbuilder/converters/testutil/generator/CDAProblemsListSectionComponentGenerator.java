...
public class CDAProblemsListSectionComponentGenerator {
	...
	private List<ProblemConcernActGenerator> problemConcernActGens;
	...
	public Component3 generate(CDAFactories factories) {
		...
		if (problemConcernActGens != null && !problemConcernActGens.isEmpty()) {
			for (ProblemConcernActGenerator actGen : problemConcernActGens) {
				section.addAct(actGen.generate(factories));
			}
		}
	...
	public void setProblemConcernActsGenerators(List<ProblemConcernActGenerator> problemConcernActGens) {
		this.problemConcernActGens = problemConcernActGens;
	}
